                      ...
                      child: Column(
                        children: [
                            ...
                            child: Row(
                              children: [
                                Container(
                                  ...
                                  child: Icon(ReclamationUi.statusIcon(rec.status), color: Colors.white, size: 28),
                                ),
                                ...
                                if (rec.resolvedAt != null || rec.updatedAt.isNotEmpty)
                                  Row(
                                    mainAxisSize: MainAxisSize.min,
                                    children: [
                          ...
                          _SectionCard(
                            ...
                            child: _ProgressBar(steps: steps),
                          ),
                          const SizedBox(height: 16),
                              ...
                              child: Column(
                                children: [
                                  ...
                                  if (meeting['location'] != null)
                                    _InfoRow('Lieu', meeting['location'].toString()),
                          ...
                          _SectionCard(
                            ...
                            child: rec.history.isEmpty
                                ...
                                : Column(
                                    children: rec.history.map((h) => _HistoryItem(history: h)).toList(),
                                  ),
                          ),
                        ],
                      ),
                          ...
                          _SectionCard(
                            ...
                            child: Column(
                              children: [
                                ...
                                if (rec.resolvedAt != null)
                                  _QuickRow('Résolu le', ReclamationUi.formatDateLong(rec.resolvedAt)),
                                _QuickRow('Délai de traitement', ReclamationUi.processingDelay(rec.createdAt, rec.resolvedAt)),
                                if (rec.academicYear.isNotEmpty)
                                  _QuickRow('Année univ.', rec.academicYear),
                              ],
                            ),
                          ),
                          if (rec.isEscalated) ...[
      ...
      child: Row(
        children: List.generate(steps.length, (i) {
          ...
          if (s.done) {
            ...
            child = Text('${i + 1}', style: TextStyle(color: Colors.grey[600], fontWeight: FontWeight.bold, fontSize: 12));
          }
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: s.active
                            ? [BoxShadow(color: (fillColor ?? Colors.blue).withOpacity(0.3), blurRadius: 0, spreadRadius: 3)]
                            : null,
                      ),
              ...
              children: stats
                  .map((s) => Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(s.$1, style: TextStyle(fontSize: 11, color: Colors.grey[600])),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(attachment.fileName, style: const TextStyle(fontWeight: FontWeight.w500)),
